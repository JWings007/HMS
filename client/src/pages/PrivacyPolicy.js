...
function LegalPolicies() {
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen text-center md:px-5">
      <h1 className="font-bold text-2xl mb-8">HMS Egg Distributors - Legal Policies</h1>

      <nav className="mb-8">
        <a href="#privacy" className="text-blue-500 border-b-2 border-blue-500 mx-2 md:text-sm">Privacy Policy</a>
        <a href="#terms" className="text-blue-500 border-b-2 border-blue-500 mx-2 md:text-sm">Terms and Conditions</a>
        <a href="#returns" className="text-blue-500 border-b-2 border-blue-500 mx-2 md:text-sm">Return Policy</a>
      </nav>
        ...
        <section id="privacy" className="mb-8">
          ...
          <ul className="list-disc text-left md:text-sm mt-2 mx-4">
            ...
            <li>
              ...
              <a href="/contact" className="text-blue-500 border-b-2 border-blue-500">Here</a>
            </li>
          </ul>
        </section>
